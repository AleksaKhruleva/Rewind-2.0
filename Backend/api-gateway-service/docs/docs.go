...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/groups/{groupId}/memories": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully listed memories",
                        "schema": {
                            "$ref": "#/definitions/responses.ListMemoriesResponse"
                        }
                    },
                    "400": {
        ...
        "/api/groups/{groupId}/memories/random": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by media type (image, video, quote) (comma-separated)",
                        "name": "media_type",
                        "in": "query"
                    },
                    {
        ...
        "/api/groups/{groupId}/memories/{memoryId}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Successfully got memory",
                        "schema": {
                            "$ref": "#/definitions/responses.DetailedMemoryResponse"
                        }
                    },
                    "400": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/responses.MemoryTagResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request - Invalid input",
    ...
    "definitions": {
        ...
        "responses.DetailedMemoryResponse": {
            "type": "object",
            "properties": {
                "isFavourite": {
                    "type": "boolean"
        ...
        "responses.ListMemoriesResponse": {
            "type": "object",
            "properties": {
                "memories": {
                    "type": "array",
        ...
        "responses.ListMemoryTagsResponse": {
            "type": "object",
            "properties": {
                "tags": {
                    "type": "array",
