...
type GroupMember struct {
	gorm.Model
	GroupID int64 `gorm:"not null;index:idx_group_user,unique"` // ID группы
	UserID  int64 `gorm:"not null;index:idx_group_user,unique"` // ID пользователя (ссылка на пользователя из Auth-Service)
	...
	MemoriesAddedCount  int64 `gorm:"default:0"`
	MemoriesViewedCount int64 `gorm:"default:0"`
