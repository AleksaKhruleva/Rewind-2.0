...
import (
	...
	"Rewind-group-service/internal/app/di"
	"Rewind-group-service/internal/db"
	"Rewind-group-service/internal/server"
)
...
func main() {
	...
	if err := server.RunGRPCServer(grpcServer, dependencies.GroupService); err != nil {
